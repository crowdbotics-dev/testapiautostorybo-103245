...
## Project Structure
    ...
    ├── testapiautostorybo_103245  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_103245`
...
2. Clone this repo and `cd testapiautostorybo_103245`
